...
<html>
    <head>
        ...
        <link rel="stylesheet" href="detected.css">
    </head>
    <body>
    <%
  ...
  %> 
    	...
    	<hr>
            ...
            <center><h3>VEHICLE REGISTRATION NUMBER DETECTION PORTAL</h3></center>
                	...
                	PreparedStatement pst = con.prepareStatement("select * from vehicle_registration.vehicle_registration_details");

                	resultSet = pst.executeQuery();
                    %>
                    <TABLE cellspacing="15" cellpadding="50" border="1" style="background-color: #ffffcc; margin-left: 600px">
					<thead>
					<TR>
